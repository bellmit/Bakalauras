...
EOF
#  #old #sshpass -p 'OR-studentui2203' scp -P 22265 -v -r target/* rokas@isk.ktu.lt:/var/www/l-s1/public_html/
...
#sshpass -p 'OR-studentui2203' ssh rokas@isk.ktu.lt -p 22265 'pkill -9 -u rokas java'
sshpass -p 'OR-studentui2203' ssh rokas@isk.ktu.lt -p 22265 'pkill -15 -u rokas java && java -Dspring.profiles.active=prod -jar /var/www/l-s1/public_html/backend.jar'
